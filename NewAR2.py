...
class AR_render:
    ...
    def draw_objects(self, image, mark_size = 0.07):
        ...
        testMatrix = np.array([-0.03016398, -0.98547478, -0.16712146, 0. ,
                                0.96621485, 0.07156421, 0.24760338, 0.,
                                -0.2559668, 0.15400654, 0.95433903, 0.,
                                -0.04349259, 0.53034111, -1.95960157, 1.])
        ...
        glMatrixMode(GL_MODELVIEW)
        glLoadIdentity()
        # model_matrix = extrinsic2ModelView(rvecs, tvecs, False)
        glLoadMatrixf(testMatrix)
